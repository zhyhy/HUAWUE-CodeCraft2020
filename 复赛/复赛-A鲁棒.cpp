/**
 * @file VectorResult.cpp
 * @brief 使用静态数组建图+visited3_2_1+迭代的predfs+vector存储结果
 * @author ZHY
 * @version 5.0
 * @date 2020-05-14
 */
   ...
   public:
    ...
    void dfsForMultithread(u32_t threadNo) {     
        ...
        for (u32_t i = 0; i < nodeCnt_; ++i) {
            ...
            // 递归版本的predfs
            // preDfs(i, i, 1, visited, visited3_2_1, 0, init_max_min_amount);
            // 迭代版本的preDfs，要快一些
            // preDfs(i, i, 1, visited, visited3_2_1, 0, init_max_min_amount);
